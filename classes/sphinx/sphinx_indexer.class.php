...
// +-------------------------------------------------+
// $Id: sphinx_indexer.class.php,v 1.17 2021/04/23 07:41:56 btafforeau Exp $
...
index '.$index_name.'
{
    ...
    /*
     * $sphinx_fields : Variable contenant les champs déjà contenus en base
     * $this->indexes : Variable contenant les champs censés être en base (/indexation/entity/champs_base.xml)
     */
