...
// +-------------------------------------------------+
// $Id: connecteurs_out_sets.class.php,v 1.23 2021/02/25 08:29:22 dgoron Exp $
...
class connector_out_setcateg {
	...
	public function get_form() {
		...
		$content_form = '
		<div class=row>
			<label class="etiquette" for="setcateg_name">'.$msg["admin_connecteurs_setcateg_name"].'</label><br />
			<input name="setcateg_name" type="text" value="'.htmlentities($this->name,ENT_QUOTES, $charset).'" class="saisie-80em">
		</div>';
		...
		$content_form .= '
		<div class=row>
			<label class="etiquette" for="setcateg_sets">'.$msg["admin_connecteurs_setcateg_includedsets"].'</label><br />
			'.$included_sets.'
		</div>';
