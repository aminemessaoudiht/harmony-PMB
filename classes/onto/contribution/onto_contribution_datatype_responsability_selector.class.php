...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_responsability_selector.class.php,v 1.10 2020/12/22 16:55:42 btafforeau Exp $
	        ...
	        foreach ($assertions as $assertion) {
	            switch ($assertion->get_predicate()) {
	                ...
	                case 'author_qualification' :
	                    $this->formated_value['author_qualification'] = json_decode($assertion->get_object());
	                    break;
	            }
	        }
	    }
            ...
            foreach (${$var_name} as $order => $data) {
                ...
                if (($data["value"] !== null) && ($data["value"] !== '')) {
                    ...
                    if (!empty($data["assertions"]["author_qualification"]["elements"])) {
                        $data_properties["object_assertions"][] = new onto_assertion($responsablity_uri, 'http://www.pmbservices.fr/ontology#author_qualification', encoding_normalize::json_encode($data["assertions"]["author_qualification"]), "", array('type'=>"literal"));
                    }
