...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_responsability_selector_ui.class.php,v 1.13 2021/01/08 14:34:40 jlaurent Exp $
        ...
        if (!empty($datas)) {
            ...
            foreach ($datas as $key => $data) {
                ...
                if ($pmb_authors_qualification) {
                    ...
                    $vedette_row = str_replace("!!vedette_author!!", $vedette_ui->get_form($property->pmb_name, $i-1, $instance_name, "", 1, true), $vedette_row);
                }
            ...
            $inside_row = $ontology_contribution_tpl['form_row_content_responsability_selector'];
            $inside_row = str_replace('!!onto_row_content_marclist_options!!', static::get_author_function_options(""), $inside_row);
