...
// +-------------------------------------------------+
// $Id: onto_common_datatype_floating_date_ui.class.php,v 1.3 2020/06/23 14:44:46 qvarin Exp $
	...
	public static function get_form($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		if (!empty($datas)) {
			...
			foreach($datas as $key=>$data){
				...
				$inside_row=str_replace("!!floating_date_value!!", (!empty($formated_value[0]) ? $formated_value[0] : '""'), $inside_row);
