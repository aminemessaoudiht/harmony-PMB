...
// +-------------------------------------------------+
// $Id: emprunteur.class.php,v 1.260 2021/06/09 07:42:46 dgoron Exp $
...
// 				$vdr=max($vdr,$valeur['org_ret_date']);
		...
		$butt_prol   = "
			...
			<input type='hidden' name='form_cb' value='$this->cb'>
			<input type='date' name='date_retbloc' value=\"$date_format_SQL\" onchange=\"$date_onchange\">
...
// 		return planning_list (0, 0, $this->id, '', '', LECTEUR_INFO_GESTION) ;
	...
	public function get_bannette_form() {
		...
		list_bannettes_abon_ui::set_empr_cb($this->cb);
