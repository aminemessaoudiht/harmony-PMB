...
// +-------------------------------------------------+
// $Id: parametres_perso.class.php,v 1.133 2021/05/27 07:59:35 dgoron Exp $
...
class parametres_perso {
	...
	public function __construct($prefix,$base_url="",$option_visibilite=array()) {
		...
		if(!isset(self::$st_fields[$this->prefix])){
			$requete="select idchamp, name, titre, type, datatype, obligatoire, ordre, options, multiple, search, export, filters, exclusion_obligatoire, pond, opac_sort, comment from ".$this->prefix."_custom order by ordre";
