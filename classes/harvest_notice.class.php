...
// +-------------------------------------------------+
// $Id: harvest_notice.class.php,v 1.6 2021/01/29 09:34:18 dgoron Exp $
...
class harvest_notice {
	...
	public function __construct($notice_id=0, $harvest_id=0, $profil_id=0) {
		$this->id=intval($notice_id);		
		$this->id_harvest=intval($harvest_id);
		$this->id_profil=intval($profil_id);
		$this->fetch_data();
	}
