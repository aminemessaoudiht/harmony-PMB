...
// +-------------------------------------------------+
// $Id: module.class.php,v 1.18 2021/06/08 16:15:42 dgoron Exp $
		...
		switch($dest) {
			...
			default:
				...
				foreach ($objects as $object) {
					if($object->name == $current_module) {
						echo window_title($database_window_title.$object->label.$msg[1003].$msg[1001]);
						break;
					}
				}
