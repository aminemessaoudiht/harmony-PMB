...
class explnum_licence {
	...
	public function get_profiles_list() {
		return list_configuration_explnum_licence_profiles_ui::get_instance(array('licence' => $this->id))->get_display_list();
	}
	
	public function get_rights_list() {
		return list_configuration_explnum_licence_rights_ui::get_instance(array('licence' => $this->id))->get_display_list();
	}
