...
// +-------------------------------------------------+
// $Id: list_reservations_ui.class.php,v 1.43 2021/04/20 14:04:17 dgoron Exp $
...
//						'resa_condition' => 'resa_condition'
	...
	protected function get_search_filter_empr_location() {
		...
		return $this->get_simple_selector($this->get_selector_query('empr_location'), 'empr_location', $msg['all_location']);
	}
