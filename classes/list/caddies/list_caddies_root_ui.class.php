...
// +-------------------------------------------------+
// $Id: list_caddies_root_ui.class.php,v 1.12 2021/06/08 07:17:35 dgoron Exp $
...
class list_caddies_root_ui extends list_ui {
	...
	protected function init_default_selection_actions() {
		...
		/*if($this->get_current_tab() == 'action_supprpanier') {
			$this->add_selection_action('supprpanier', $msg['caddie_menu_action_supprpanier'], '', $this->get_link_action('panier', 'list_supprpanier'));
		 }*/
	}
