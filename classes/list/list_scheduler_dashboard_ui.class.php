...
// +-------------------------------------------------+
// $Id: list_scheduler_dashboard_ui.class.php,v 1.21 2021/05/26 09:54:22 dgoron Exp $
...
class list_scheduler_dashboard_ui extends list_ui {
	...
	protected function get_search_filter_types() {
		...
		return $this->get_multiple_selector('', 'types', $msg['scheduler_all'], $options);
	}
	...
	protected function get_search_filter_labels() {
		...
		return $this->get_multiple_selector($query, 'labels', $msg['scheduler_all']);
	}
	...
	protected function get_search_filter_states() {
		...
		return $this->get_multiple_selector('', 'states', $msg['scheduler_all'], $options);
	}
