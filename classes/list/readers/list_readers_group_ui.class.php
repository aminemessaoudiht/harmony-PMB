...
// +-------------------------------------------------+
// $Id: list_readers_group_ui.class.php,v 1.3 2021/04/20 06:44:56 dgoron Exp $
...
class list_readers_group_ui extends list_readers_ui {
	...
	protected function init_default_pager() {
	    ...
	    //formulaire au dessus de la liste
	    if ($empr_allow_prolong_members_group && $this->filters['group']) {
	        $group = new group($this->filters['group']);
	        $this->pager['nb_per_page'] = $group->nb_members; //Illimité;
