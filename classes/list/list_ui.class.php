...
// +-------------------------------------------------+
// $Id: list_ui.class.php,v 1.178 2021/06/11 07:37:25 dgoron Exp $
...
// 		$this->set_settings_in_session();
	...
	protected function get_simple_selector($query, $name='', $message_all='', $options=array()) {
		global $charset;
	
		$selector = "<select name='".$this->objects_type."_".$name."' class='list_ui_simple_selector ".$this->objects_type."_simple_selector'>";
		if($message_all) {
	...
	protected function get_multiple_selector($query, $name='', $message_all='', $options=array()) {
		global $charset;
		
		$selector = "<select name='".$this->objects_type."_".$name."[]' multiple='3' class='list_ui_multiple_selector ".$this->objects_type."_multiple_selector'>";
		if($message_all) {
