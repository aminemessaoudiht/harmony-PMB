...
// +-------------------------------------------------+
// $Id: list_rent_accounts_ui.class.php,v 1.9 2021/05/25 11:12:21 dgoron Exp $
...
class list_rent_accounts_ui extends list_rent_ui {
	...
	protected function get_search_filter_invoiced() {
		...
		return $this->get_simple_selector('', 'invoiced', '', $options);
	}
	...
	protected function get_search_filter_request_status() {
		...
		return $this->get_simple_selector('', 'request_status', '', $options);
	}
