...
// +-------------------------------------------------+
// $Id: list_recouvr_reader_ui.class.php,v 1.1 2021/05/03 07:18:23 dgoron Exp $
	...
	protected function get_selection_actions() {
		...
		if(!isset($this->selection_actions)) {
			...
			$this->selection_actions = array(
					$this->get_selection_action('del_line', $msg['relance_recouvrement_del_all_lines'], '', $del_line_link),
					$this->get_selection_action('solde', $msg['relance_recouvrement_solder'], '', $solde_link)
			);
