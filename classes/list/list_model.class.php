...
// +-------------------------------------------------+
// $Id: list_model.class.php,v 1.12 2021/06/10 14:56:12 dgoron Exp $
...
class list_model {
	...
	public function get_query_if_exists() {
		return " SELECT count(1) FROM lists WHERE list_label = '".addslashes($this->label)."' AND list_num_user = '".$this->num_user."' AND list_objects_type = '".$this->objects_type."'";
	}
