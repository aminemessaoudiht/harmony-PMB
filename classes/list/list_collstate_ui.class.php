...
// +-------------------------------------------------+
// $Id: list_collstate_ui.class.php,v 1.13 2021/04/22 11:40:33 dgoron Exp $
...
// 					$collstate_list_header_deb.="<th class='collstate_header_".$colonnesarray[$i]."'>".htmlentities($colencours,ENT_QUOTES, $charset)."</th>";
	...
	public function get_display_list() {
		...
		if(count($this->objects)) {
			$display .= "<table id='".$this->objects_type."_list' class='list_ui_list ".$this->objects_type."_list exemplaires'>";
