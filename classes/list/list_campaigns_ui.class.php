...
// +-------------------------------------------------+
// $Id: list_campaigns_ui.class.php,v 1.33 2021/05/26 10:14:38 dgoron Exp $
...
// 				'relances' => $msg["campaign_type_relances"]
		...
		return $this->get_multiple_selector('', 'types', $msg['campaigns_all'], $options);
	}
	...
	protected function get_search_filter_labels() {
		...
		return $this->get_multiple_selector($query, 'labels', $msg['campaigns_all']);
	}
