...
// +-------------------------------------------------+
// $Id: list_translations_ui.class.php,v 1.9 2021/05/25 11:12:21 dgoron Exp $
...
class list_translations_ui extends list_ui {
	...
	protected function get_search_filter_root() {
		...
		return $this->get_simple_selector('', 'root', '', $options);
	}
	...
	protected function get_search_filter_module() {
		...
		return $this->get_simple_selector('', 'module', '', $options);
	}
	...
	protected function get_search_filter_classifications() {
		...
		return $this->get_multiple_selector('', 'classifications', $msg['all'], $options);
	}
