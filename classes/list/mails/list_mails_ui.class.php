...
// +-------------------------------------------------+
// $Id: list_mails_ui.class.php,v 1.2 2021/06/07 09:51:48 dgoron Exp $
...
class list_mails_ui extends list_ui {
	...
	protected function get_search_filter_from_name() {
		global $msg;
		return $this->get_multiple_selector($this->get_selector_query('from_name'), 'from_name', $msg["all"]);
	}
	...
	protected function get_js_sort_script_sort() {
		...
		$display = str_replace('!!categ!!', 'mails', $display);
