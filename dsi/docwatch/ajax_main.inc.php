...
// +-------------------------------------------------+
// $Id: ajax_main.inc.php,v 1.45 2020/10/01 07:41:42 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

global $class_path, $sub, $action, $msg;
global $id, $watch_id, $item_id, $class, $autoloader, $deflt_docwatch_watch_filter_deleted;
