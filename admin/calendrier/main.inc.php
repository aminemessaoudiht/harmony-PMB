...
// +-------------------------------------------------+
// $Id: main.inc.php,v 1.25 2021/02/09 07:25:05 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

global $class_path, $faire, $book_location_id, $loc, $date_deb, $date_fin, $commentaire, $duplicate_locs;
global $page, $annee, $date;
