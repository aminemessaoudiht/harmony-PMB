...
// +-------------------------------------------------+
// $Id: gen_signature_notice.inc.php,v 1.7 2020/11/23 14:18:09 dgoron Exp $
...
if(pmb_mysql_num_rows($query)) {
	print netbase::get_display_progress($start, $count);
   	while ($row = pmb_mysql_fetch_row($query) )  { 		
		...
		pmb_mysql_query("update notices set signature='$val', update_date=update_date where notice_id=".$row[0], $dbh);		
   	}
