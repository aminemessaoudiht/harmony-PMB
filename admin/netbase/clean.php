...
// +-------------------------------------------------+
// $Id: clean.php,v 1.45 2021/05/26 09:34:59 dgoron Exp $
...
if(!$spec) {
	...
	$spec += (isset($index_date_flot) ? $index_date_flot : 0);
	$spec += (isset($clean_cache_apcu) ? $clean_cache_apcu : 0);
	$spec += (isset($clean_entities_data) ? $clean_entities_data : 0);
}
$spec = intval($spec);
if($spec) {
