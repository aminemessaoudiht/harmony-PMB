...
// +-------------------------------------------------+
// $Id: cart.php,v 1.38 2020/11/16 11:34:34 dgoron Exp $
...
switch ($action) {
	case 'new_cart':
		...
		$form_action = "./cart.php?action=valid_new_cart".($list_ui_objects_type ? "&list_ui_objects_type=".$list_ui_objects_type : "")."&object_type=".$object_type."&item=".$item.(isset($current_print) ? "&current_print=".$current_print : "") . 
