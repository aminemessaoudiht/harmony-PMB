...
// +-------------------------------------------------+
// $Id: main.inc.php,v 1.68 2021/04/21 20:49:30 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

global $class_path, $include_path, $msg, $charset, $action, $sub, $database_window_title, $PMBuserid;
...
switch($sub) {
	...
	case 'encours':
		...
		$list_reservations_circ_ui->set_object_id($ancre);
