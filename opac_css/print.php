...
// +--------------------------------------------------------------------------+
// $Id: print.php,v 1.129 2021/04/20 12:29:51 rtigero Exp $
			...
			function checkForSubmit(){
				...
				if (selnotices) {
					if (document.getElementById('oute').checked) {
						if(!is_valid_mail(document.getElementById('emailexp').value) && parseInt(".$opac_print_email_sender_mandatory.")) {
