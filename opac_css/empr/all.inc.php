...
// +-------------------------------------------------+
// $Id: all.inc.php,v 1.85 2021/06/09 12:21:21 dgoron Exp $
				...
				if($opac_pret_prolongation) {
	                ...
	                <form style='margin-bottom:0px;padding-bottom:0px;' action='empr.php?tab=loan_reza&lvl=all&id_groupe=" . $r_goupe->id_groupe . "' method='post' name='FormGroup'>
	            		<div class='row'>
	            			...
	            			<input type='date' name='group_prolonge_pret_date' id='group_prolonge_pret_date' value='' title='" . $msg['group_prolonge_pret_date_title'] . "' />
	            		</div>
	                </form>";
				}
			} else {
