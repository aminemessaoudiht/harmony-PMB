...
global $opac_export_allow, $opac_notices_depliable, $begin_result_liste, $cart_aff_case_traitement, $nb_per_page_custom, $opac_cart_more_actions_activate;
...
if (!empty($cart_)) {
	...
	if ($opac_cart_more_actions_activate) {
        print "<span class=\"espaceCartAction\">&nbsp;</span>
    	   <input type='button' id='show_cart_more_actions' class='bouton' value=\"".$msg['show_cart_more_actions']."\" title=\"".$msg['show_cart_more_actions']."\" onClick=\"show_more_actions();\" />";
	    print "<script type='text/javascript' >
    	...
    	print "<div id='show_more_actions' style='display: none;'>";
	}
