...
// +-------------------------------------------------+
// $Id: common.tpl.php,v 1.275 2021/06/02 08:41:57 dgoron Exp $
...
if ($opac_cookies_consent && (!isset($_COOKIE['PhpMyBibli-COOKIECONSENT']) || $_COOKIE['PhpMyBibli-COOKIECONSENT'] == "" || $_COOKIE['PhpMyBibli-COOKIECONSENT'] == "false")) {
