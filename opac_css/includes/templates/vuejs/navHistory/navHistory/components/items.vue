<template>
	<g class="items">
		...
		<g class="item" @click="focusItem()" @mouseenter="mouseHover($event)" :data-id_item="item.id">
		...
		<g v-if="canShowBtn" class="btn-link" @click="moveToParent()" :transform="`translate(${item.x-(cercle.r*2)}, ${item.y+cercle.r})`">
