...
// +-------------------------------------------------+
// $Id: search_universe.tpl.php,v 1.17 2020/04/22 14:01:27 qvarin Exp $
...
$search_universe_form = "
    <div id='search_universe_container'>
        ...
        <div class='row' id='search_universe_form_input'>
             <form id='search_universe_input' name='search_universe_input' action='".$base_path."!!url!!' method='post' onSubmit=\"if (search_universe_input.user_query.value.length == 0) { search_universe_input.user_query.value='*'; return true; }\">
