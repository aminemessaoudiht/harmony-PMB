...
// +-------------------------------------------------+
// $Id: liste_lecture.class.php,v 1.73 2021/01/27 10:22:06 dgoron Exp $
...
class liste_lecture {
	...
	public function affichage_saveform($notice_asso=array()){
		...
		if(!$this->id_liste){
			...
			$form = str_replace('!!notice_filtre!!',htmlentities(implode(',',$notice_asso),ENT_QUOTES,$charset),$form);
		} else {
			//Recherche
			$this->search_in_list();
