...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_resource_selector_ui.class.php,v 1.51 2021/04/20 09:54:54 qvarin Exp $
	...
	public static function get_form($item_uri, $property, $restrictions, $datas, $instance_name, $flag) {
		...
		if (!empty($datas)) {
			...
			foreach($datas as $key => $data) {
				...
				$row = str_replace("!!onto_row_inputs!!", self::get_inputs($item_uri, $property, $order, $add_button, $management_data, $new_element_order), $row);
