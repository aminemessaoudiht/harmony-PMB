...
// +-------------------------------------------------+
// $Id: search_view.class.php,v 1.29 2021/02/09 14:11:19 dgoron Exp $
...
class search_view {
	...
	public static function get_display_extended_search_form() {
		...
		$form.="<br /><br />
			...
			".($onglet_persopac ? "<input type='hidden' name='onglet_persopac' value='".htmlentities($onglet_persopac,$charset,ENT_QUOTES)."'/>" : "")."
		</form>
	...
	public static function get_display_term_search_form() {
		...
		if ($opac_show_help) $form .= "<input type='submit' class='bouton button_search_help' value='$msg[search_help]' onClick='window.open(\"help.php?whatis=search_terms\", \"search_help\", \"scrollbars=yes, toolbar=no, dependent=yes, width=400, height=400, resizable=yes\"); return false' />\n";
