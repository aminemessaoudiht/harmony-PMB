...
// +-------------------------------------------------+
// $Id: search_segment_external_search_result.class.php,v 1.8 2021/05/11 08:20:58 jlaurent Exp $
...
// 	    	$user_query_mc = $this->format_search($user_query_mc);
	...
	public function get_display_facets() {
	    ...
	    $search_defaut_segment = json_decode($this->segment->get_set()->get_data_set());
	    $this->undisplayed_search_index = array_keys($search_defaut_segment->SEARCH);
	    search_universes_history::$undisplayed_search_index = $this->undisplayed_search_index;
