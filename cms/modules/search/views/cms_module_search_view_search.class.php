...
// +-------------------------------------------------+
// $Id: cms_module_search_view_search.class.php,v 1.36 2021/02/04 09:33:42 dgoron Exp $
...
class cms_module_search_view_search extends cms_module_common_view{
	...
	public function render($datas){
		...
		if ($this->parameters['link_search_advanced']) {
			...
			$html.="
				<p class='search_advanced_link'><a href='./index.php?search_type_asked=".$search_type_asked."'>".$this->format_text($this->msg['cms_module_search_view_link_search_advanced_display'])."</a></p>";
		}
