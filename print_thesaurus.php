...
// +-------------------------------------------------+
// $Id: print_thesaurus.php,v 1.31 2021/04/14 19:13:37 touraine37 Exp $
...
if ($action != "print") {
	...
	print "\n</select>
		...
		<blockquote>
			...
			<input type='checkbox' name='aff_num_aut' value='1'/>&nbsp;".$msg['print_thes_num_aut']."
		</blockquote>
...
function infos_noeud($idnoeud, $niveau, $profondeurmax) {
	...
	global $aff_note_application, $aff_commentaire, $aff_voir, $aff_voir_aussi, $aff_tg, $aff_ts, $aff_no_trad, $aff_num_aut;
