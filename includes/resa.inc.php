...
// +-------------------------------------------------+
// $Id: resa.inc.php,v 1.57 2020/06/11 10:36:10 jlaurent Exp $
...
function alert_empr_resa($id_resa=0, $id_empr_concerne=0, $print_mode=0) {
	...
	while ($empr=pmb_mysql_fetch_object($result)) {
		...
		if ($lock_validation || $pdflettreresa_priorite_email==3) continue;
	...
	if (empty($lock_validation)  || $pdflettreresa_priorite_email != 3){
