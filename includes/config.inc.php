...
// +-------------------------------------------------+
// $Id: config.inc.php,v 1.242.2.2 2021/06/11 10:32:29 qvarin Exp $

// fichier de configuration générale

$pmb_version = "</b>7.4.RC1</b>";
$pmb_version_brut = "7.4.RC1";
$pmb_version_database_as_it_should_be = "v5.35";
$pmb_subversion_database_as_it_shouldbe = "1";
...
$KEY_CACHE_FILE_XML = 'key_cache_file_xml'.md5(getcwd());//Prefix pour la cle des variables en cache pour les fichiers XML
