							...
							<div id="el0Child_0a" class="row uk-clearfix">
								<table>
									...
									<tr v-for="registred in registration">
										...
										<td>{{ registred.nbRegistredPersons }}</td>
									</tr>
								</table>
							</div>
						</div>
					...
					<div id="el1Child" class="child" style="display: block;">
						...
						<div id="el1Child_3">
							<div id="el1Child_3a">
								...
								<input type='checkbox' id="mailingAssociatedCampaign" name='mailingAssociatedCampaign' :value="0" v-model="dataMail.mailingAssociatedCampaign"/>
							</div>					
						</div>
						<div id="el1Child_4">
							<div id="el1Child_4a">
...
<script>
	export default {
		props : ["pmb", "animation", "action", "img", "registration", "formdata", "mailingdetail"],
		data:function(){
			return {
				dataMail:{},
				tplSelected : 0,
