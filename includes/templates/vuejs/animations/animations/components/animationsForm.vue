				...
				<div id="el1Child" class="child" style="display: block;">
					<div id="el1Child_0">
						...
						<div id="el1Child_0b" class="row uk-clearfix">
							<input v-model="animation.event.startDate" type="date" :max="animation.event.endDate"/>
					...
					<div id="el1Child_1">
						...
						<div id="el1Child_1b" class="row uk-clearfix">
							<input v-model="animation.event.endDate" type="date" :min="animation.event.startDate"/>
