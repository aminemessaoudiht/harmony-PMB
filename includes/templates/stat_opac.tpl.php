...
// +-------------------------------------------------+
// $Id: stat_opac.tpl.php,v 1.12 2021/05/04 06:41:27 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $msg, $stat_view_addview_form, $stat_view_addcol_form, $stat_view_request_form, $stat_view_import_req_form, $current_module;
