...
// +-------------------------------------------------+
// $Id: fournisseurs.tpl.php,v 1.29 2021/03/23 08:43:33 dgoron Exp $


if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $id_bibli, $coord_content_form2, $current_module, $msg, $charset, $search_form, $cond_form, $frame, $bt_add, $rem_form, $bt_sup, $histrel_form, $histrel_hrow_form, $acquisition_gestion_tva, $acquisition_gestion_tva;
