...
// +-------------------------------------------------+
// $Id: list_ui.tpl.php,v 1.42 2021/06/11 07:37:25 dgoron Exp $
...
global $list_ui_datasets_content_form_tpl, $list_ui_settings_content_form_tpl, $list_ui_js_sort_script_sort, $list_ui_search_add_filter_form_tpl, $list_ui_search_order_form_tpl, $list_dataset_form_tpl;
...
$list_ui_js_sort_script_sort = "
	<script type='text/javascript'>
		function !!objects_type!!_sort_by(criteria, asc_desc, indice) {
			...
			req.request(url,1, 'object_type=!!objects_type!!&filters='+filters+'&pager='+pager+'&ancre='+ancre, true, function(response) {
				...
				if(ancre) {
					window.location='#!!objects_type!!_object_list_ancre';
				}
            });
		}
	</script>
