...
// +-------------------------------------------------+
// $Id: onto_skos_concept_item.tpl.php,v 1.24 2021/06/10 13:26:10 gneveu Exp $
...
<script type="text/javascript">
	...
	function onto_open_selector(element_name,range, att_id_filter) {
		try {
			...
			openPopUp("select.php?what=ontology&caller="+caller+"&objs="+objs+"&element=concept&element_name="+element+"&dyn=1&att_id_filter="+encodeURI(att_id_filter)+"&deb_rech=", "select_object", 500, 400, 0, 0, "infobar=no, status=no, scrollbars=yes, toolbar=no, menubar=no, dependent=yes, resizable=yes");
			return false;
