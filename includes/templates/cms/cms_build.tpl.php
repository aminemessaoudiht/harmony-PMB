...
// +-------------------------------------------------+
// $Id: cms_build.tpl.php,v 1.89 2020/12/23 11:43:46 jlaurent Exp $
...
<script type='text/javascript'>
    ...
    function cms_clean_cache(){
        dojo.request.xhr(document.getElementById('opac_frame').src+'action=clean_cache').then(function(data){
