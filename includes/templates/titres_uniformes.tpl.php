...
// +-------------------------------------------------+
// $Id: titres_uniformes.tpl.php,v 1.88 2020/04/10 13:16:08 dgoron Exp $
...
<div id='f_oeuvre_expression_from!!ioeuvre_expression_from!!' class='row' dragtype='oeuvre_expression_from' draggable='yes' recept='yes' recepttype='oeuvre_expression_from' handler='f_oeuvre_expression_from!!ioeuvre_expression_from!!_handle' dragicon='".get_url_icon('icone_drag_notice.png')."' dragtext='!!oeuvre_expression_from!!' downlight=\"oeuvre_expression_from_downlight\" highlight=\"oeuvre_expression_from_highlight\" order='!!ioeuvre_expression_from!!'  style='' >
	...
	!!expression_type!!
	<input type='text' class='saisie-30emr' callback='formMapperCallback' id='f_oeuvre_expression_from!!ioeuvre_expression_from!!_display_label' name='f_oeuvre_expression_from!!ioeuvre_expression_from!!' data-form-name='f_oeuvre_expression_from' value=\"!!oeuvre_expression_from!!\" completion=\"titre_uniforme\" autfield=\"f_oeuvre_expression_from_code!!ioeuvre_expression_from!!\" />
