...
<script>
    ...
    function check_new_password() {
        ...
        let empr_id = !!id!!;
		//si lecteur deja existant et mot de passe vide, on considere que le mot de passe ne doit pas etre verifie
		if( (0 != empr_id) && ('' == new_password) ) {
			return true;
		}
