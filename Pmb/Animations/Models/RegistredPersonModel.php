...
// +-------------------------------------------------+
// $Id: RegistredPersonModel.php,v 1.28 2021/03/29 08:56:38 qvarin Exp $
...
class RegistredPersonModel extends Model
{
    ...
    {
        $registredPerson = RegistredPersonOrm::find("num_empr", $emprId . "' AND num_registration = '$registrationId");
